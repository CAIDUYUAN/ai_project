...
1. 배민셀프서비스 접속 (self.baemin.com)
2. 정산관리 → 매출상세내역
3. 기간 선택 → 엑셀 다운로드
4. 매입: 정산관리 → 매입상세내역 → 엑셀 다운로드
5. 두 파일을 함께 업로드하면 자동 인식됩니다`,

    cp: `📋 쿠팡이츠 매출 다운로드 방법

1. 쿠팡이츠 사장님 사이트 접속 (store.coupangeats.com)
2. 정산 → 정산내역
3. 월 선택 → 엑셀 다운로드
4. 파일명: coupang_eats_YYYY-MM.xlsx`,

    tg: `📋 땡겨요 매출/매입 다운로드 방법

1. 땡겨요 사장님 사이트 접속 (ceo.ddangyo.com)
2. 정산관리 → 매출내역 → 엑셀 다운로드
3. 정산관리 → 매입내역 → 엑셀 다운로드
4. 파일명: 땡겨요 YYYY년 MM월 매출/매입`,

    yg: `📋 요기요 매출/매입 다운로드 방법

1. 요기요 사장님 사이트 접속 (ceo.yogiyo.co.kr)
2. 정산 → 부가세 신고자료 → 월 선택
3. 매출/매입 각각 엑셀 다운로드
4. 두 파일을 함께 업로드하면 자동 인식됩니다`,
  };
